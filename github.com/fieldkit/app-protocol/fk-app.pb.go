...
func (x *ModuleHttpQuery) GetType() QueryType {
	if x != nil {
		return x.Type
	}
	return QueryType_QUERY_NONE
...
var file_fk_app_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x70, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x25, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x85, 0x01, 0x0a,
	...
	0x2e, 0x66, 0x6b, 0x5f, 0x61, 0x70, 0x70, 0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x54, 0x79, 0x70,
...
var file_fk_app_proto_goTypes = []interface{}{
	...
	(*ModuleHttpQuery)(nil),      // 61: fk_app.ModuleHttpQuery
	(*ModuleHttpReply)(nil),      // 62: fk_app.ModuleHttpReply
	(*UdpMessage)(nil),           // 63: fk_app.UdpMessage
}
var file_fk_app_proto_depIdxs = []int32{
	...
	1,  // 76: fk_app.ModuleHttpQuery.type:type_name -> fk_app.QueryType
	30, // 77: fk_app.ModuleHttpQuery.errors:type_name -> fk_app.Error
	2,  // 78: fk_app.ModuleHttpReply.type:type_name -> fk_app.ReplyType
	30, // 79: fk_app.ModuleHttpReply.errors:type_name -> fk_app.Error
	6,  // 80: fk_app.UdpMessage.status:type_name -> fk_app.UdpStatus
