...
typedef enum _fk_app_QueryType {
    ...
    fk_app_QueryType_QUERY_DOWNLOAD_DATA_SET = 4,
    fk_app_QueryType_QUERY_ERASE_DATA_SET = 5
} fk_app_QueryType;
#define _fk_app_QueryType_MIN fk_app_QueryType_QUERY_NONE
#define _fk_app_QueryType_MAX fk_app_QueryType_QUERY_ERASE_DATA_SET
#define _fk_app_QueryType_ARRAYSIZE ((fk_app_QueryType)(fk_app_QueryType_QUERY_ERASE_DATA_SET+1))
...
#define _fk_app_ReplyType_MAX fk_app_ReplyType_REPLY_DATA_SETS
#define _fk_app_ReplyType_ARRAYSIZE ((fk_app_ReplyType)(fk_app_ReplyType_REPLY_DATA_SETS+1))
...
#define fk_app_DataSet_init_default              {0, 0, {{NULL}, NULL}, 0, 0, 0}
...
#define fk_app_DataSetData_init_default          {0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define fk_app_EraseDataSet_init_default         {0}
#define fk_app_WireMessageQuery_init_default     {(fk_app_QueryType)0, fk_app_QueryCapabilities_init_default, fk_app_ConfigureSensorQuery_init_default, fk_app_QueryDataSets_init_default, fk_app_DownloadDataSet_init_default, fk_app_EraseDataSet_init_default}
#define fk_app_Error_init_default                {{{NULL}, NULL}}
#define fk_app_WireMessageReply_init_default     {(fk_app_ReplyType)0, {{NULL}, NULL}, fk_app_Capabilities_init_default, fk_app_DataSets_init_default, fk_app_DataSetData_init_default}
...
#define fk_app_DataSet_init_zero                 {0, 0, {{NULL}, NULL}, 0, 0, 0}
#define fk_app_DataSets_init_zero                {{{NULL}, NULL}}
#define fk_app_DownloadDataSet_init_zero         {0, 0}
#define fk_app_Sample_init_zero                  {0, 0}
#define fk_app_DataSetData_init_zero             {0, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define fk_app_EraseDataSet_init_zero            {0}
#define fk_app_WireMessageQuery_init_zero        {(fk_app_QueryType)0, fk_app_QueryCapabilities_init_zero, fk_app_ConfigureSensorQuery_init_zero, fk_app_QueryDataSets_init_zero, fk_app_DownloadDataSet_init_zero, fk_app_EraseDataSet_init_zero}
...
#define fk_app_WireMessageQuery_downloadDataSet_tag 5
#define fk_app_WireMessageQuery_eraseDataSet_tag 6
...
extern const pb_field_t fk_app_DataSet_fields[7];
...
extern const pb_field_t fk_app_DataSetData_fields[5];
extern const pb_field_t fk_app_EraseDataSet_fields[2];
extern const pb_field_t fk_app_WireMessageQuery_fields[7];
extern const pb_field_t fk_app_Error_fields[2];
extern const pb_field_t fk_app_WireMessageReply_fields[6];
