...
/* Generated by nanopb-0.3.9-dev at Wed Oct 18 10:02:08 2017. */
...
const pb_field_t fk_app_DataSetData_fields[6] = {
    ...
    PB_FIELD(  4, FLOAT   , REPEATED, CALLBACK, OTHER, fk_app_DataSetData, data, samples, 0),
    PB_FIELD(  5, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DataSetData, hash, data, 0),
    PB_LAST_FIELD
};
