...
/* Generated by nanopb-0.3.9-dev at Thu Feb 15 15:57:19 2018. */
...
const pb_field_t fk_app_DownloadDataSet_fields[5] = {
    ...
    PB_FIELD(  3, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DownloadDataSet, pageSize, page, 0),
    PB_FIELD(  4, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_DownloadDataSet, token, pageSize, 0),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_DataSetData_fields[9] = {
    PB_FIELD(  1, UINT32  , SINGULAR, STATIC  , FIRST, fk_app_DataSetData, page, page, 0),
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, fk_app_DataSetData, samples, page, &fk_app_Sample_fields),
    PB_FIELD(  3, FLOAT   , REPEATED, CALLBACK, OTHER, fk_app_DataSetData, floats, samples, 0),
    PB_FIELD(  4, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_DataSetData, data, floats, 0),
    PB_FIELD(  5, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DataSetData, sensor, data, 0),
    PB_FIELD(  6, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DataSetData, size, sensor, 0),
    PB_FIELD(  7, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_DataSetData, token, size, 0),
    PB_FIELD(  8, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DataSetData, hash, token, 0),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_WireMessageQuery_fields[15] = {
...
const pb_field_t fk_app_WireMessageReply_fields[14] = {
