...
const pb_field_t fk_app_Schedule_fields[1] = {
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_File_fields[7] = {
    ...
    PB_FIELD(  3, UINT64  , SINGULAR, STATIC  , OTHER, fk_app_File, size, time, 0),
    ...
    PB_FIELD(  6, UINT64  , SINGULAR, STATIC  , OTHER, fk_app_File, maximum, name, 0),
    PB_LAST_FIELD
};
