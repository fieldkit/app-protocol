...
/* Generated by nanopb-0.3.9-dev at Thu Oct 19 11:38:32 2017. */
...
const pb_field_t fk_app_LiveData_fields[2] = {
    PB_FIELD(  1, MESSAGE , REPEATED, CALLBACK, FIRST, fk_app_LiveData, dataSetDatas, dataSetDatas, &fk_app_DataSetData_fields),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_WireMessageQuery_fields[9] = {
