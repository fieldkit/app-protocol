...
/* Generated by nanopb-0.3.9-dev at Tue Oct 24 10:51:13 2017. */
...
const pb_field_t fk_app_SensorCapabilities_fields[5] = {
    ...
    PB_FIELD(  4, STRING  , SINGULAR, CALLBACK, OTHER, fk_app_SensorCapabilities, unitOfMeasure, frequency, 0),
    PB_LAST_FIELD
};
