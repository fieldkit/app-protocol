...
/* Generated by nanopb-0.3.9-dev at Tue Dec 12 10:54:45 2017. */
...
const pb_field_t fk_app_Capabilities_fields[5] = {
    ...
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, fk_app_Capabilities, name, version, 0),
    PB_FIELD(  3, MESSAGE , REPEATED, CALLBACK, OTHER, fk_app_Capabilities, modules, name, &fk_app_ModuleCapabilities_fields),
    PB_FIELD(  4, MESSAGE , REPEATED, CALLBACK, OTHER, fk_app_Capabilities, sensors, modules, &fk_app_SensorCapabilities_fields),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_NetworkSettings_fields[4] = {
    PB_FIELD(  1, INT32   , SINGULAR, STATIC  , FIRST, fk_app_NetworkSettings, createAccessPoint, createAccessPoint, 0),
    PB_FIELD(  2, STRING  , SINGULAR, CALLBACK, OTHER, fk_app_NetworkSettings, ssid, createAccessPoint, 0),
    PB_FIELD(  3, STRING  , SINGULAR, CALLBACK, OTHER, fk_app_NetworkSettings, password, ssid, 0),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_DownloadFile_fields[4] = {
    ...
    PB_FIELD(  3, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_DownloadFile, token, page, 0),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_FileData_fields[5] = {
    ...
    PB_FIELD(  3, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_FileData, hash, data, 0),
    PB_FIELD(  4, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_FileData, token, hash, 0),
    PB_LAST_FIELD
};

const pb_field_t fk_app_WireMessageQuery_fields[12] = {
    ...
    PB_FIELD( 11, MESSAGE , SINGULAR, STATIC  , OTHER, fk_app_WireMessageQuery, networkSettings, downloadFile, &fk_app_NetworkSettings_fields),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_WireMessageReply_fields[11] = {
