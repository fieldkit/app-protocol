...
/* Generated by nanopb-0.3.9-dev at Thu Oct 19 10:53:18 2017. */
...
const pb_field_t fk_app_DataSetData_fields[7] = {
    ...
    PB_FIELD(  3, MESSAGE , REPEATED, CALLBACK, OTHER, fk_app_DataSetData, samples, page, &fk_app_Sample_fields),
    PB_FIELD(  4, FLOAT   , REPEATED, CALLBACK, OTHER, fk_app_DataSetData, floats, samples, 0),
    PB_FIELD(  5, BYTES   , SINGULAR, CALLBACK, OTHER, fk_app_DataSetData, data, floats, 0),
    PB_FIELD(  6, UINT32  , SINGULAR, STATIC  , OTHER, fk_app_DataSetData, hash, data, 0),
    PB_LAST_FIELD
};

const pb_field_t fk_app_LiveData_fields[3] = {
    PB_FIELD(  1, BOOL    , SINGULAR, STATIC  , FIRST, fk_app_LiveData, busy, busy, 0),
    PB_FIELD(  2, MESSAGE , SINGULAR, STATIC  , OTHER, fk_app_LiveData, dataSetData, busy, &fk_app_DataSetData_fields),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_WireMessageQuery_fields[8] = {
...
const pb_field_t fk_app_WireMessageReply_fields[7] = {
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_app_LiveData, dataSetData) < 65536 && pb_membersize(fk_app_WireMessageQuery, queryCapabilities) < 65536 && pb_membersize(fk_app_WireMessageQuery, configureSensor) < 65536 && pb_membersize(fk_app_WireMessageQuery, queryDataSets) < 65536 && pb_membersize(fk_app_WireMessageQuery, queryDataSet) < 65536 && pb_membersize(fk_app_WireMessageQuery, downloadDataSet) < 65536 && pb_membersize(fk_app_WireMessageQuery, eraseDataSet) < 65536 && pb_membersize(fk_app_WireMessageReply, capabilities) < 65536 && pb_membersize(fk_app_WireMessageReply, dataSets) < 65536 && pb_membersize(fk_app_WireMessageReply, dataSetData) < 65536 && pb_membersize(fk_app_WireMessageReply, liveData) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_fk_app_QueryCapabilities_fk_app_SensorCapabilities_fk_app_Capabilities_fk_app_ConfigureSensorQuery_fk_app_QueryDataSets_fk_app_DataSet_fk_app_DataSets_fk_app_DownloadDataSet_fk_app_Sample_fk_app_DataSetData_fk_app_LiveData_fk_app_QueryDataSet_fk_app_EraseDataSet_fk_app_WireMessageQuery_fk_app_Error_fk_app_WireMessageReply)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(fk_app_LiveData, dataSetData) < 256 && pb_membersize(fk_app_WireMessageQuery, queryCapabilities) < 256 && pb_membersize(fk_app_WireMessageQuery, configureSensor) < 256 && pb_membersize(fk_app_WireMessageQuery, queryDataSets) < 256 && pb_membersize(fk_app_WireMessageQuery, queryDataSet) < 256 && pb_membersize(fk_app_WireMessageQuery, downloadDataSet) < 256 && pb_membersize(fk_app_WireMessageQuery, eraseDataSet) < 256 && pb_membersize(fk_app_WireMessageReply, capabilities) < 256 && pb_membersize(fk_app_WireMessageReply, dataSets) < 256 && pb_membersize(fk_app_WireMessageReply, dataSetData) < 256 && pb_membersize(fk_app_WireMessageReply, liveData) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_fk_app_QueryCapabilities_fk_app_SensorCapabilities_fk_app_Capabilities_fk_app_ConfigureSensorQuery_fk_app_QueryDataSets_fk_app_DataSet_fk_app_DataSets_fk_app_DownloadDataSet_fk_app_Sample_fk_app_DataSetData_fk_app_LiveData_fk_app_QueryDataSet_fk_app_EraseDataSet_fk_app_WireMessageQuery_fk_app_Error_fk_app_WireMessageReply)
#endif
