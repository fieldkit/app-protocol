...
const pb_field_t fk_app_Capabilities_fields[6] = {
    ...
    PB_FIELD(  2, UINT32  , REPEATED, CALLBACK, OTHER, fk_app_Capabilities, deviceId, version, 0),
...
const pb_field_t fk_app_Identity_fields[4] = {
    ...
    PB_FIELD(  3, UINT32  , REPEATED, CALLBACK, OTHER, fk_app_Identity, deviceId, stream, 0),
    PB_LAST_FIELD
};
