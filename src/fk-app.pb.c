...
/* Generated by nanopb-0.3.9-dev at Wed Dec 13 11:35:20 2017. */
...
const pb_field_t fk_app_Identity_fields[3] = {
...
const pb_field_t fk_app_WireMessageQuery_fields[13] = {
    ...
    PB_FIELD( 12, MESSAGE , SINGULAR, STATIC  , OTHER, fk_app_WireMessageQuery, identity, networkSettings, &fk_app_Identity_fields),
    PB_LAST_FIELD
};
