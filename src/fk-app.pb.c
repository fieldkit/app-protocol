...
/* Generated by nanopb-0.3.9-dev at Fri Dec  8 10:46:35 2017. */
...
const pb_field_t fk_app_File_fields[6] = {
    ...
    PB_FIELD(  5, STRING  , SINGULAR, CALLBACK, OTHER, fk_app_File, name, pages, 0),
    PB_LAST_FIELD
};
...
const pb_field_t fk_app_WireMessageReply_fields[10] = {
