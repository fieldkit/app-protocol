...
#define _fk_app_QueryType_MAX fk_app_QueryType_QUERY_CONFIGUE_SCHEDULES
#define _fk_app_QueryType_ARRAYSIZE ((fk_app_QueryType)(fk_app_QueryType_QUERY_CONFIGUE_SCHEDULES+1))
...
#define fk_app_TimeSpec_init_default             {0, 0}
...
#define fk_app_TimeSpec_init_zero                {0, 0}
...
#define fk_app_WireMessageReply_init_zero        {(fk_app_ReplyType)0, {{NULL}, NULL}, fk_app_Capabilities_init_zero, fk_app_DataSets_init_zero, fk_app_DataSetData_init_zero, fk_app_LiveData_init_zero, fk_app_Schedules_init_zero}
...
extern const pb_field_t fk_app_TimeSpec_fields[3];
...
extern const pb_field_t fk_app_WireMessageQuery_fields[10];
extern const pb_field_t fk_app_Error_fields[2];
extern const pb_field_t fk_app_WireMessageReply_fields[8];
...
#define fk_app_TimeSpec_size                     22
#define fk_app_Schedule_size                     96
#define fk_app_Schedules_size                    392
...
#define fk_app_WireMessageQuery_size             465
