...
typedef enum _fk_app_QueryType {
    ...
    fk_app_QueryType_QUEYR_CONFIGURE_SENSOR = 2,
...
#define _fk_app_QueryType_MAX fk_app_QueryType_QUERY_LIVE_DATA_POLL
#define _fk_app_QueryType_ARRAYSIZE ((fk_app_QueryType)(fk_app_QueryType_QUERY_LIVE_DATA_POLL+1))
...
#define _fk_app_ReplyType_MAX fk_app_ReplyType_REPLY_LIVE_DATA_POLL
#define _fk_app_ReplyType_ARRAYSIZE ((fk_app_ReplyType)(fk_app_ReplyType_REPLY_LIVE_DATA_POLL+1))
...
#define fk_app_SensorCapabilities_init_default   {0, {{NULL}, NULL}, 0}
...
#define fk_app_DataSetData_init_default          {0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define fk_app_LiveData_init_default             {0, fk_app_DataSetData_init_default}
#define fk_app_QueryDataSet_init_default         {0}
#define fk_app_EraseDataSet_init_default         {0}
#define fk_app_WireMessageQuery_init_default     {(fk_app_QueryType)0, fk_app_QueryCapabilities_init_default, fk_app_ConfigureSensorQuery_init_default, fk_app_QueryDataSets_init_default, fk_app_QueryDataSet_init_default, fk_app_DownloadDataSet_init_default, fk_app_EraseDataSet_init_default}
#define fk_app_Error_init_default                {{{NULL}, NULL}}
#define fk_app_WireMessageReply_init_default     {(fk_app_ReplyType)0, {{NULL}, NULL}, fk_app_Capabilities_init_default, fk_app_DataSets_init_default, fk_app_DataSetData_init_default, fk_app_LiveData_init_default}
#define fk_app_QueryCapabilities_init_zero       {0}
#define fk_app_SensorCapabilities_init_zero      {0, {{NULL}, NULL}, 0}
...
#define fk_app_DataSetData_init_zero             {0, 0, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, 0}
#define fk_app_LiveData_init_zero                {0, fk_app_DataSetData_init_zero}
#define fk_app_QueryDataSet_init_zero            {0}
#define fk_app_EraseDataSet_init_zero            {0}
#define fk_app_WireMessageQuery_init_zero        {(fk_app_QueryType)0, fk_app_QueryCapabilities_init_zero, fk_app_ConfigureSensorQuery_init_zero, fk_app_QueryDataSets_init_zero, fk_app_QueryDataSet_init_zero, fk_app_DownloadDataSet_init_zero, fk_app_EraseDataSet_init_zero}
#define fk_app_Error_init_zero                   {{{NULL}, NULL}}
#define fk_app_WireMessageReply_init_zero        {(fk_app_ReplyType)0, {{NULL}, NULL}, fk_app_Capabilities_init_zero, fk_app_DataSets_init_zero, fk_app_DataSetData_init_zero, fk_app_LiveData_init_zero}
...
#define fk_app_DataSetData_samples_tag           3
#define fk_app_DataSetData_floats_tag            4
#define fk_app_DataSetData_data_tag              5
#define fk_app_DataSetData_hash_tag              6
...
#define fk_app_SensorCapabilities_frequency_tag  3
#define fk_app_LiveData_busy_tag                 1
#define fk_app_LiveData_dataSetData_tag          2
...
extern const pb_field_t fk_app_SensorCapabilities_fields[4];
...
extern const pb_field_t fk_app_DataSetData_fields[7];
extern const pb_field_t fk_app_LiveData_fields[3];
extern const pb_field_t fk_app_QueryDataSet_fields[2];
extern const pb_field_t fk_app_EraseDataSet_fields[2];
extern const pb_field_t fk_app_WireMessageQuery_fields[8];
extern const pb_field_t fk_app_Error_fields[2];
extern const pb_field_t fk_app_WireMessageReply_fields[7];

/* Maximum encoded size of messages (where known) */
#define fk_app_QueryCapabilities_size            6
...
#define fk_app_LiveData_size                     (8 + fk_app_DataSetData_size)
#define fk_app_QueryDataSet_size                 6
#define fk_app_EraseDataSet_size                 6
#define fk_app_WireMessageQuery_size             56
