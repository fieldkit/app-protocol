...
#define _fk_app_ReplyType_MAX fk_app_ReplyType_REPLY_DOWNLOAD_DATA_SET
#define _fk_app_ReplyType_ARRAYSIZE ((fk_app_ReplyType)(fk_app_ReplyType_REPLY_DOWNLOAD_DATA_SET+1))
