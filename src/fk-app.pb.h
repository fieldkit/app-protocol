...
#define fk_app_SensorCapabilities_init_default   {0, {{NULL}, NULL}, 0, {{NULL}, NULL}}
...
#define fk_app_SensorCapabilities_init_zero      {0, {{NULL}, NULL}, 0, {{NULL}, NULL}}
...
#define fk_app_SensorCapabilities_unitOfMeasure_tag 4
...
extern const pb_field_t fk_app_SensorCapabilities_fields[5];
...
#define fk_app_WireMessageQuery_size             70
