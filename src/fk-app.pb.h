...
#define _fk_app_QueryType_MAX fk_app_QueryType_QUERY_CONFIGURE_NETWORK_SETTINGS
#define _fk_app_QueryType_ARRAYSIZE ((fk_app_QueryType)(fk_app_QueryType_QUERY_CONFIGURE_NETWORK_SETTINGS+1))
...
#define _fk_app_ReplyType_MAX fk_app_ReplyType_REPLY_NETWORK_SETTINGS
#define _fk_app_ReplyType_ARRAYSIZE ((fk_app_ReplyType)(fk_app_ReplyType_REPLY_NETWORK_SETTINGS+1))
...
#define fk_app_NetworkSettings_init_default      {0, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define fk_app_NetworkSettings_init_zero         {0, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define fk_app_WireMessageQuery_init_zero        {(fk_app_QueryType)0, fk_app_QueryCapabilities_init_zero, fk_app_ConfigureSensorQuery_init_zero, fk_app_QueryDataSets_init_zero, fk_app_QueryDataSet_init_zero, fk_app_DownloadDataSet_init_zero, fk_app_EraseDataSet_init_zero, fk_app_LiveDataPoll_init_zero, fk_app_Schedules_init_zero, fk_app_DownloadFile_init_zero, fk_app_NetworkSettings_init_zero}
#define fk_app_Error_init_zero                   {{{NULL}, NULL}}
#define fk_app_WireMessageReply_init_zero        {(fk_app_ReplyType)0, {{NULL}, NULL}, fk_app_Capabilities_init_zero, fk_app_DataSets_init_zero, fk_app_DataSetData_init_zero, fk_app_LiveData_init_zero, fk_app_Schedules_init_zero, fk_app_Files_init_zero, fk_app_FileData_init_zero, fk_app_NetworkSettings_init_zero}
...
#define fk_app_NetworkSettings_ssid_tag          2
#define fk_app_NetworkSettings_password_tag      3
...
extern const pb_field_t fk_app_NetworkSettings_fields[4];
...
extern const pb_field_t fk_app_WireMessageQuery_fields[12];
extern const pb_field_t fk_app_Error_fields[2];
extern const pb_field_t fk_app_WireMessageReply_fields[11];
...
#define fk_app_WireMessageQuery_size             (657 + fk_app_DownloadFile_size + fk_app_NetworkSettings_size)
