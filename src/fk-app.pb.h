...
typedef enum _fk_app_ReplyType {
    ...
    fk_app_ReplyType_REPLY_MODULE = 15
} fk_app_ReplyType;
...
extern const pb_field_t fk_app_WireMessageQuery_fields[15];
extern const pb_field_t fk_app_Error_fields[2];
extern const pb_field_t fk_app_WireMessageReply_fields[14];
...
#define fk_app_WireMessageQuery_size             (669 + fk_app_DownloadDataSet_size + fk_app_DownloadFile_size + fk_app_NetworkSettings_size + fk_app_Identity_size + fk_app_QueryModule_size)
