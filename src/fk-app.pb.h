...
#define _fk_app_QueryType_MAX fk_app_QueryType_QUERY_DOWNLOAD_FILE
#define _fk_app_QueryType_ARRAYSIZE ((fk_app_QueryType)(fk_app_QueryType_QUERY_DOWNLOAD_FILE+1))
...
#define _fk_app_ReplyType_MAX fk_app_ReplyType_REPLY_DOWNLOAD_FILE
#define _fk_app_ReplyType_ARRAYSIZE ((fk_app_ReplyType)(fk_app_ReplyType_REPLY_DOWNLOAD_FILE+1))
...
#define fk_app_DownloadFile_init_default         {0, 0}
#define fk_app_FileData_init_default             {0, {{NULL}, NULL}, 0}
...
#define fk_app_DownloadFile_init_zero            {0, 0}
#define fk_app_FileData_init_zero                {0, {{NULL}, NULL}, 0}
...
extern const pb_field_t fk_app_DownloadFile_fields[3];
extern const pb_field_t fk_app_FileData_fields[4];
...
#define fk_app_DownloadFile_size                 12
/* fk_app_FileData_size depends on runtime parameters */
#define fk_app_WireMessageQuery_size             659
