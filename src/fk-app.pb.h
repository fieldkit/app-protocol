...
#define fk_app_DownloadFile_init_default         {0, 0, 0}
#define fk_app_EraseFile_init_default            {0}
#define fk_app_FileData_init_default             {0, {{NULL}, NULL}, 0, 0}
...
#define fk_app_DownloadFile_init_zero            {0, 0, 0}
#define fk_app_EraseFile_init_zero               {0}
#define fk_app_FileData_init_zero                {0, {{NULL}, NULL}, 0, 0}
...
#define fk_app_DownloadFile_size                 18
...
#define fk_app_WireMessageQuery_size             (659 + fk_app_NetworkSettings_size + fk_app_Identity_size + fk_app_QueryModule_size)
