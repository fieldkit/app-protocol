...
typedef enum _fk_app_QueryType {
    ...
    fk_app_QueryType_QUERY_NETWORK_SETTINGS = 13,
    fk_app_QueryType_QUERY_CONFIGURE_NETWORK_SETTINGS = 14,
    fk_app_QueryType_QUERY_IDENTITY = 15,
    fk_app_QueryType_QUERY_CONFIGURE_IDENTITY = 16,
    fk_app_QueryType_QUERY_STATUS = 17
} fk_app_QueryType;
...
#define fk_app_Identity_init_default             {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define fk_app_Identity_init_zero                {{{NULL}, NULL}, {{NULL}, NULL}}
...
#define fk_app_WireMessageQuery_networkSettings_tag 11
#define fk_app_WireMessageQuery_identity_tag     12
...
extern const pb_field_t fk_app_Identity_fields[3];
...
extern const pb_field_t fk_app_WireMessageQuery_fields[13];
...
#define fk_app_WireMessageQuery_size             (663 + fk_app_DownloadFile_size + fk_app_NetworkSettings_size + fk_app_Identity_size)
