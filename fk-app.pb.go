...
const (
	...
	QueryType_QUERY_IDENTITY                   QueryType = 15
	QueryType_QUERY_CONFIGURE_IDENTITY         QueryType = 16
	QueryType_QUERY_STATUS                     QueryType = 17
)
...
func (*FileData) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (*DeviceStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
type WireMessageQuery struct {
	...
	Identity          *Identity             `protobuf:"bytes,12,opt,name=identity" json:"identity,omitempty"`
}
...
func (*WireMessageQuery) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*WireMessageReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
var fileDescriptor0 = []byte{
	...
	,
}
