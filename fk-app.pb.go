...
var file_fk_app_proto_rawDesc = []byte{
	...
	0x5f, 0x46, 0x4c, 0x41, 0x47, 0x5f, 0x4e, 0x4f, 0x4e, 0x45, 0x10, 0x00, 0x42, 0x20, 0x0a, 0x1e,
	0x6f, 0x72, 0x67, 0x2e, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x66, 0x79, 0x2e, 0x66,
	0x69, 0x65, 0x6c, 0x64, 0x6b, 0x69, 0x74, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x70, 0x62, 0x62, 0x06,
...
var file_fk_app_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_fk_app_proto_goTypes = []interface{}{
	...
	(*HttpReply)(nil),            // 55: fk_app.HttpReply
}
var file_fk_app_proto_depIdxs = []int32{
	...
	2,  // 60: fk_app.HttpReply.type:type_name -> fk_app.ReplyType
	29, // 61: fk_app.HttpReply.errors:type_name -> fk_app.Error
	39, // 62: fk_app.HttpReply.status:type_name -> fk_app.Status
	13, // 63: fk_app.HttpReply.networkSettings:type_name -> fk_app.NetworkSettings
	43, // 64: fk_app.HttpReply.loraSettings:type_name -> fk_app.LoraSettings
	10, // 65: fk_app.HttpReply.modules:type_name -> fk_app.ModuleCapabilities
	49, // 66: fk_app.HttpReply.streams:type_name -> fk_app.DataStream
	52, // 67: fk_app.HttpReply.liveReadings:type_name -> fk_app.LiveReadings
	32, // 68: fk_app.HttpReply.schedules:type_name -> fk_app.Schedules
	46, // 69: fk_app.HttpReply.transmission:type_name -> fk_app.Transmission
	54, // 70: fk_app.HttpReply.listing:type_name -> fk_app.DirectoryListing
